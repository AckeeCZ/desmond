...
function promisify<T1, T2, T3, TRes>(
    fn: (p1: T1, p2: T2, p3: T3, cb: Callback<TRes>) => any
): (a1: T1, a2: T2, a3: T3) => Promise<TRes>;
function promisify<T1, T2, T3, T4, TRes>(
    fn: (p1: T1, p2: T2, p3: T3, p4: T4, cb: Callback<TRes>) => any
): (a1: T1, a2: T2, a3: T3, a4: T4) => Promise<TRes>;
